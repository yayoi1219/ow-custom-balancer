/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ed049642ddc61bad1a852748e9452f8)
// Runtime types generated with workerd@1.20260801.1 2025-09-01 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	TURNSTILE_SITE_KEY: "1x00000000000000000000AA";
	ROOM: DurableObjectNamespace<import("./src/worker/index").RoomDurableObject>;
	RATE_LIMIT: DurableObjectNamespace<import("./src/worker/index").RateLimitDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "RoomDurableObject" | "RateLimitDurableObject";
	}
